...
class PartialParse(object):
    def __init__(self, sentence):
        ...
        ### Initially stack contains the token "ROOT"
        self.stack = ["ROOT"]

        ### Initially buffer contains all the words present in the sentence
        self.buffer = copy.deepcopy(sentence)

        ### List of dependencies is an empty list
        self.dependencies = []
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while len(unfinished_parses) != 0:
      ...
      for j in range(0, len(delete)):
        del unfinished_parses[delete[j]]
